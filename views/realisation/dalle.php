...
<head>
    ...
    <link rel="canonical" href="https://www.galicia37.com/realisation/dalle.html">
    <link rel="icon" type="image/x-icon" href="../../img/logo.jpg">
    <link rel="stylesheet" href="../../css/style.css">
    <link rel="stylesheet" href="../../css/footer.css">
    <link rel="stylesheet" href="../../css/formulaire.css">
    <link rel="stylesheet" href="../../css/responsive.css">
    <title>Réalisation Dalle Béton</title>
    <meta name="Réalisation de Dalle béton" content="La fondation et la dalle sont des étapes importantes.L'entreprise Galicia s'engage à une réalisation en béton"/>
        ...
        <main class="main">
            ...
            <div class="row">
                <div class="column">
                    <?php
                        $image = new Image();
                        $carrelages = $image->getImages(DALLE_DIR_PATH);
                    ?>
                </div>
            </div>
